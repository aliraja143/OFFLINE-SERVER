    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.YELLOW + f"[+] Priya ke chut par sms gaya{message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
            except requests.exceptions.RequestException as e:
                print(Fore.RED + f"[x] SAHI TOKEN DAL OR FIR PRIYA KO CHODNA  {message_index + 1} T0 C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} - Error: {e}")
...
def main():
    ...
    print(Fore.MAGENTA + " PRIYA KE CHUT FADNE VALI NITU  ")
    print(Fore.CYAN + "------------------------------------")
